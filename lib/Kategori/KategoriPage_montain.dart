...
import 'package:project_mobile/Detail/DetailPage_montain.dart';
import 'package:project_mobile/models/viewmodels/fetch_data_montain.dart';

class KategoriPage_montain extends StatelessWidget {
  final String selectedCategory;

  KategoriPage_montain({required this.selectedCategory, Key? key}) : super(key: key);
