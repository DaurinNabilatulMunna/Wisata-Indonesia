...
import 'package:project_mobile/Detail/DetailPage_heritage.dart';
import 'package:project_mobile/models/viewmodels/fetch_data_heritage.dart';

class KategoriPage_heritage extends StatelessWidget {
  final String selectedCategory;

  KategoriPage_heritage({required this.selectedCategory, Key? key}) : super(key: key);
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.hasData) {
                      return ListView.builder(
                        ...
                        itemCount: snapshot.data.length > 25 ? 25
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => DetailPage_heritage(
