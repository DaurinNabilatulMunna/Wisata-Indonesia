...
import 'package:project_mobile/Detail/DetailPage_city.dart';
import 'package:project_mobile/models/viewmodels/fetch_data_city.dart';

class KategoriPage extends StatelessWidget {
  final String selectedCategory;

  KategoriPage({required this.selectedCategory, Key? key}) : super(key: key);
