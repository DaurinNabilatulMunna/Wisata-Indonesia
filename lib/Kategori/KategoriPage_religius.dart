...
import 'package:project_mobile/Detail/DetailPage_religius.dart';
import 'package:project_mobile/models/viewmodels/fetch_data_religius.dart';

class KategoriPage_religius extends StatelessWidget {
  final String selectedCategory;

  KategoriPage_religius({required this.selectedCategory, Key? key}) : super(key: key);
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.hasData) {
                      return ListView.builder(
                        ...
                        itemCount: snapshot.data.length > 20 ? 20
                                ...
                                InkWell(
                                  onTap: () {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => DetailPage_religius(
