...
class DetailPage_top extends StatefulWidget {
  final String wisataId;

  DetailPage_top({required this.wisataId});

  @override
  _DetailPageState createState() => _DetailPageState();
}

class _DetailPageState extends State<DetailPage_top> {
  ...
  Future<Wisata> fetchData() async {
    ...
    Wisata selectedWisata =
        data.firstWhere((wisata) => wisata.gambar == widget.wisataId);
